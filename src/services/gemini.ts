...
/** Сейчас в Алматы: строка для промпта + часть суток (чтобы модель не писала про «вечер», когда ночь) */
...
/** Прогноз на 24 ч по одному показателю — вызывается по кнопке на странице деталей */
